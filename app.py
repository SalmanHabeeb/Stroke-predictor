...
age = st.number_input('Age :', min_value = 0.25, max_value = 80.0, value = 40.0)
residence = st.selectbox('Residence type :', ['Urban', 'Rural'])
glucose_level = st.number_input('Average Glucose Level(in mg/dL) :', min_value = 10.0, max_value = 400.0, value = 115.0)
